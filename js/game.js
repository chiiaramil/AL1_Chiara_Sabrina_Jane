...
function endGame() {
  ...
  `;
    ...
    <button onclick="this.parentElement.remove(); document.querySelector('.game_container').style.display = 'none'; document.querySelector('.collect_points').classList.remove('hidden');">Member werden</button>
  `;
